...
ggplot(data = mod1_condense_df) + 
  geom_pointrange(data = mod1_condense_df[c(37:48),], aes(x = term, y = estimate, ymin = conf.low, ymax = conf.up), color = "red") +
  geom_hline(yintercept = 0) +
  labs(x = "Air Temperature Effects",
       y = "Est. Air Temp Effects") +
