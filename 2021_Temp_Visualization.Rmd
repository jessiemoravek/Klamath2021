...
#z score the data
dat_mean2 <- matrix7
transformed_dat2 <-log(dat_mean2)
transformed_dat2 <- zscore(transformed_dat2)
...
mod9$B = "diagonal and unequal" #assuming no species interactions
mod9$U = "unequal" #no trend because we z scored 
