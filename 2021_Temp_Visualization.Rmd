...
matrix7 <- matrix(nrow=29,ncol=22)
matrix7[1,] <- AP1_daily$mean_temp
matrix7[2,c(4:22)] <- AP2_daily$mean_temp
matrix7[3,c(4:22)] <- AP3_daily$mean_temp
matrix7[4,c(5:22)] <- APck_daily$mean_temp
matrix7[5,c(5:22)] <- SP1_daily$mean_temp
matrix7[6,c(5:22)] <- SP2_daily$mean_temp
matrix7[8,c(7:11)] <- SPck_daily$mean_temp
matrix7[9,c(7:22)] <- Durazo_daily$mean_temp
matrix7[10,c(7:22)] <- LS_daily$mean_temp
matrix7[11,c(7:22)] <- LSck_daily$mean_temp
matrix7[12,c(7:22)] <- May_daily$mean_temp
matrix7[13,c(7:22)] <- MayCk_daily$mean_temp
matrix7[15,c(4:21)] <- FG2_daily$mean_temp
matrix7[16,c(4:21)] <- FG3_daily$mean_temp
matrix7[17,c(4:21)] <- FGck_daily$mean_temp
matrix7[18,c(3:21)] <- GP1_daily$mean_temp
matrix7[19,c(3:21)] <- GP2_daily$mean_temp
matrix7[20,c(3:21)] <- GP3_daily$mean_temp
matrix7[21,c(10:21)] <- GPck_daily$mean_temp
matrix7[22,c(1:21)] <- ULout_daily$mean_temp
matrix7[23,c(1:21)] <- UL1_daily$mean_temp
matrix7[25,c(1:21)] <- UL3_daily$mean_temp
matrix7[26,c(1:21)] <- ULck_daily$mean_temp
matrix7[27,c(3:21)] <- LL1_daily$mean_temp
matrix7[28,c(3:21)] <- LL2_daily$mean_temp
matrix7[29,c(3:21)] <- LL3_daily$mean_temp
