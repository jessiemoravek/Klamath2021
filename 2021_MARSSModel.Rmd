...
mod11$Z = matrix2
mod11$R = "diagonal and equal" #all the sensors are the same type, so observation error should be the same
mod11$Q = "diagonal and unequal" #(also try Equalvarcov)
mod11$B = "identity" #assuming no species interactions
mod11$U = "zero" #no trend because we z scored 
mod11$C = "unequal" #I think I can set C to unequal because it is going off the Z matrix where I have already indicated how to split up the sites.
mod11$c = matrixc
